...
public class TBoard {
   ...
   public TBoard(int tNo, String tTitle, int tPrice, Date createDate, int tCount, String memberNo, String status,
         String titleImg) {
      super();
      this.tNo = tNo;
      this.tTitle = tTitle;
   ...
   public TBoard(int tNo, String tTitle, int tPrice, int categoryNo, Date createDate, int tCount, String memberNo,
   ...
   public TBoard(int tNo, String tTitle, int categoryNo, String content, Date createDate, String memberNo, int tPrice,
         String status, String bookStatus, String categoryName) {
      super();
      this.tNo = tNo;
      this.tTitle = tTitle;
      this.categoryNo = categoryNo;
   ...
   public TBoard(int tNo, String tTitle, int tPrice, int categoryNo, String bookStatus, String content,
         Date createDate, String memberNo, String status, String categoryName, String map) {
      super();
      this.tNo = tNo;
      this.tTitle = tTitle;
      this.tPrice = tPrice;
