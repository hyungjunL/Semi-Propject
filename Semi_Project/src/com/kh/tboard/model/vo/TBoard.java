...
public class TBoard {
	...
	public TBoard(int tNo, String tTitle, int categoryNo, String content, Date createDate, String memberNo,int tPrice,String status, String bookStatus,String categoryName) {
		super();
		this.tNo = tNo;
		this.tTitle = tTitle;
		this.categoryNo = categoryNo;
