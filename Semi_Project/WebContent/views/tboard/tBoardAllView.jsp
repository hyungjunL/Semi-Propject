...
<%
	...
	ArrayList<TBoard> indexAllList = (ArrayList<TBoard>)request.getAttribute("indexAllList");
...
<div id="wrap">
    ...
    <div class="contentwrap"></div>
     ...
     <div align="center" class="paging-area">
        ...
        <% if(currentPage != 1) { %>
            <button class = "btn-page" onclick="location.href='<%= contextPath %>/listAll.it?currentPage=<%= currentPage - 1 %>'">&lt;</button>
        <% } %>
        ...
        <% for(int i = startPage; i <= endPage; i++) { %>
            ...
            <% if(i != currentPage) { %>
                <button  class = "btn-page" onclick="location.href='<%= contextPath %>/listAll.it?currentPage=<%= i %>'"><%= i %></button>
            <% } else { %>
