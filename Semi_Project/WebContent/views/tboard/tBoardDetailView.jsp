...
<body>
	...
	<div id="wrap">
	    ...
	    <br>
		<div class="t_map" align="center">
            <table border="1">
               <tr>
                  <th height="200">거래 장소 :</th>
                  <td width="500"; height="400"><img src="" alt="">
                     <div id="map" style="width: 100%; height: 400px;"></div></td>
               </tr>
            </table>
         </div>
         <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=1f16fb3a33259fb72c322808eeaef2d6&libraries=services,clusterer,drawing"></script>
